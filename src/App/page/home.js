            ...
            <Row >
                <Col className="relative heighth-100 zindex-10" >
                    <div ref={(r) => { this.$$action0 = r; }}>
                        <Row className="absolute width-100 top-1 zindex-10" justify="center">
                            <Col span={17.5} className="bg-000 opacity-8 padding-all border-radius-5f content-dom">
                                <Row className="">
                        ...
                        <Row className="absolute width-100 bottom-3r  zindex-10" align={'center'} justify={'center'}>
                            <Col span={11.5}>
                ...
                <Col className="zindex-10 bg-show" >
                    ...
                    <Row className={"margin-top-5r bg-f5f5f5"} justify="center">
                        <Col span={17}  className={`${activeNum > 1 ? 'bottom-in' : 'bottom-out'} content-dom`}>
                        ...
                        <Col span={17} className={`${activeNum > 1 ? 'bottom-in' : 'bottom-out'} margin-top-2r margin-bottom-2r`}>
                            {typeDom}
                        </Col>
                    </Row>
                    </div>
