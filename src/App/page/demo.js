...
class Demo extends Component {
    ...
    render() {
        ...
        const carouselMap = [{ tabName: 'first', content: (<img alt="text" src="/oldNode/getphotoPal/2018-12-11/15445075526162.png" />), isActive: true },
        { tabName: 'second', content: (<img alt="text" src="/oldNode/getphotoPal/2018-12-11/15445096249305.png" />), isActive: false },
        { tabName: 'thired', content: (<img alt="text" src="/oldNode/getphotoPal/2017-3-28/14906636798813.jpg" />), isActive: false }];
