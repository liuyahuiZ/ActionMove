        ...
        return(
            <Row>
                <Col className=" padding-bottom-1r bg-F6F6F6 relative">
                    {screenWidth < 750 ? <Row className="zindex-10 padding-bottom-1r margin-bottom-3r relative " justify="center">
                        <Col  span={22} className="margin-top-3r ">
                            <Row justify="center">
                                <Col >
                                    <div className="width-100 relative text-align-center line-height-3r">上海小鸟环保科技有限公司</div>
                                    <div className="width-100 relative text-align-center line-height-2r">商务合作：bird@time.com</div>
                                    <div className="width-100 relative text-align-center line-height-2r">客服电话：021-54930202</div>
                                    <div className="width-100 relative text-align-center line-height-2r">工作时间：9:30-18:30</div>
                                </Col>
                                
                            </Row>
                        </Col>
                        
                    </Row> :<Row className="zindex-10 padding-bottom-1r margin-bottom-3r relative " justify="center">
                        <Col  span={14} className="margin-top-3r ">
                            <Row justify="center">
                                <Col span={8}>
                                    <div className="width-100 relative text-align-left line-height-3r">上海小鸟环保科技有限公司</div>
                                ...
                                <Col span={16}>
                                    <div className="width-100 line-height-3r">关于我们</div>
